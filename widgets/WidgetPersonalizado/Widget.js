define(['dojo/_base/declare', 'jimu/LayerStructure','jimu/BaseWidget'],
  function(declare, LayerStructure, BaseWidget) {
    ...
    return declare([BaseWidget], {
      ...
      baseClass: 'jimu-widget-widgetPersonalizado',
      ...
      _tablaInformacion = this.tablaInfoMapa;
      _tablasCapas = this.tablaListadoCapas;
      ...
      onOpen: function(){
        ...
        _tablasCapas.innerHTML += "<tr><td>" + layerNode.title + "</td><td>" + layerNode._layerInfo.id + "</td></tr>";
         });
      } else {
